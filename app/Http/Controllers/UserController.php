...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($existed) {
            $data = [
                'status' => 419,
                'message' => '事業所が既に登録されています。',
                'existed_user' => $existed // Include any additional data you want to send to the view
            ];
    ...
    public function update(Request $request)
    {
        ...
        $update_c_member_email = $request->update_c_member_email;
